    ...
    <div className='invisible sm:visible fixed w-full z-60'>
      <header className=' text-center overflow-hidden lg:max-w-9xl sticky top-0 z-50 grid grid-cols-3  bg-white shadow-sm pt-2'>
        ...
        <div className=' pb-1 '>
          <button
            style={{ color: "#ed0e3f" }}
            className=' active:ring-offset-4 active:ring ring-pink-800 py-2 px-3 text-sm md:text-lg duration-200 rounded-md font-medium  hover:bg-gray-100'>
            تسجيل الدخول
          </button>
          <button
            style={{ color: "white", backgroundColor: "#ed0e3f" }}
            className='active:ring-offset-4 active:ring ring-pink-800 hidden md:inline-block hover:bg-red-800 duration-200 py-2 px-3 font-medium ml-2 rounded-md'>
            إنشاء حساب
          </button>
        </div>
      </header>
