...
function NavNavbarMobol(props) {
  ...
  var x = "border-b-4 border-red-500  bg-red-200  duration-300 rounded-t-md";

  return (
    <div>
      <header className='  block sm:hidden mt-[-4px] overflow-hidden lg:max-w-9xl sticky top-0 z-50  dark:bg-gray-900/90 backdrop-blur-md  bg-white shadow-sm pt-2'>
        <div className=' mx-3 gap-4  md:mx-15 xl:mx-16 grid md:outline-hidden grid-cols-5    text-center'>
          <Link href='/' passHref>
            <div className={props.home}>
              <div className='cursor-pointer  noselect  py-2 ease-out  transition  duration-200 dark:hover:bg-gray-700 hover:bg-gray-100 rounded-lg  '>
                <svg
          ...
          <Link href='video' passHref>
            <div className={props.video}>
              <div className=' cursor-pointer  noselect py-2 transition  duration-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg  '>
                <svg
                  className='h-6 pt-1 w-6 mx-auto'
                  xmlns='http://www.w3.org/2000/svg'
                  id='Outline'
          ...
          <Link href='shop' passHref>
            <div className={props.shop}>
              <div className=' cursor-pointer  noselect py-2 transition  duration-200  dark:hover:bg-gray-700  hover:bg-gray-100 rounded-lg  '>
                <svg
                  className='h-6 pt-1 w-6 mx-auto'
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 24 24'
          ...
          <div onClick={toggle} className={showMe ? x : " "}>
            <div className=' cursor-pointer noselect py-2 ease-out  transition  duration-200    rounded-lg  '>
              <svg
                className='h-6 pt-1 w-6 mx-auto'
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
