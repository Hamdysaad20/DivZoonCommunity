    ...
    <div>
      <header className='  block sm:hidden mt-[-4px] overflow-hidden lg:max-w-9xl sticky top-0 z-50   bg-white shadow-sm pt-2'>
        <div className=' mx-3 gap-4 mx-1 md:mx-15 xl:mx-16 grid md:outline-hidden grid-cols-5    text-center'>
          ...
          <div onClick={toggle} className={showMe ? x : ""}>
            <div className=' cursor-pointer hover:bg-red-100  noselect py-2 ease-out  transition  duration-200 hover:bg-gray-100 rounded-lg  '>
              <svg
                className='h-6 pt-1 w-6 mx-auto'
                xmlns='http://www.w3.org/2000/svg'
                viewBox='0 0 24 24'
      ...
      <div>
        <div
          ...
          className=' sm:hidden mr-3 ml-3'>
          <div className='sm:hidden cursor-pointer  noselect  flex flex-cols-2 md:mr-16 lg:mr-32 xl:mr-20 2xl:mr-44 text-right justify-end  p-2  rounded-md  hover:bg-gray-100 duration-300'>
            <div className='sm:hidden  mr-2 text-lg font-semibold'>
              {" "}
              هات قهوتك
            </div>
          ...
          <div className='sm:hidden cursor-pointer  noselect  flex flex-cols-2  md:mr-16 lg:mr-32 xl:mr-20 2xl:mr-44  p-2 text-right justify-end  rounded-md  hover:bg-gray-100 duration-300'>
          ...
          <div className='sm:hidden  cursor-pointer  noselect  flex flex-cols-2 md:mr-16 lg:mr-32 xl:mr-20 2xl:mr-44  p-2   text-right justify-end rounded-md  hover:bg-gray-100 duration-300'>
            <div className='text-left mr-2 text-lg font-semibold'>
              المحفوظات
            </div>
            <div className='   '>
              <svg
