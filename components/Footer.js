function Layout() {
    ...
    <h2 className="text-xs font-thin text-gray-400">
       ...
       . <span className="noselect hover:text-gray-800">الاعلانات</span>
    </h2>
     <hr className="noselect  absolute right-0 left-0 bottom-9"/>
       <h1 className=" noselect absolute right-0 left-0 bottom-2   text-gray-500 hover:text-gray-800 font-medium ">Created By Divzoon &copy;</h1>
         </div>  
        </div>
</footer>
    )
