...
function BlogPost(props) {
  ...
  return (
        ...
        <div className=" shadow-md bg-gray-300 h-[500px] mt-4 z-10  relative  mx-auto max-w-2xl rounded-md ">
           <div className=" h-[250px] r  rounded-t-md ">
           <Image alt="UserImage" className=" object-cover rounded-t-md" layout="fill"  src="https://res.cloudinary.com/divzoon2022/image/upload/v1641347288/cld-sample.jpg" height="80"  width="80"/>

           </div>
            <div className="bg-gray-50 absolute w-full  rounded-b-md bottom-0 z-20 h-[250px] ">
...
<div className="h-10 mt-2 w-10"> 
    <Image alt="UserImage" className="noselect  rounded-lg" src={props.userImage} height="80"  width="80"/>
</div>
                </div>
...
">
<div onClick={updateReaction} className="flex mx-3 gap-2 active:scale-105 duration-100   justify-center pl-4 " >
    <h1 className="noselect text-md  text-gray-500 font-medium">وااو</h1> 
 {  cliked ?  <svg className="h-8 md:p-1 p-2 w-8 "  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 23a7.5 7.5 0 0 1-5.138-12.963C8.204 8.774 11.5 6.5 11 1.5c6 4 9 8 3 14 1 0 2.5 0 5-2.47.27.773.5 1.604.5 2.47A7.5 7.5 0 0 1 12 23z"/></svg> : <svg  className="h-8 md:p-1 p-2 w-8 "  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 23a7.5 7.5 0 0 0 7.5-7.5c0-.866-.23-1.697-.5-2.47-1.667 1.647-2.933 2.47-3.8 2.47 3.995-7 1.8-10-4.2-14 .5 5-2.796 7.274-4.138 8.537A7.5 7.5 0 0 0 12 23zm.71-17.765c3.241 2.75 3.257 4.887.753 9.274-.761 1.333.202 2.991 1.737 2.991.688 0 1.384-.2 2.119-.595a5.5 5.5 0 1 1-9.087-5.412c.126-.118.765-.685.793-.71.424-.38.773-.717 1.118-1.086 1.23-1.318 2.114-2.78 2.566-4.462z"/></svg>    
...
<div className="h-[90px] bg-gray-100 mt-2 active:scale-105 rounded-md duration-300">
