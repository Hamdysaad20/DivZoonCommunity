...
function loading() {
  return (
    <div className='z-70  duration-700 relative mx-auto  justify-center  my-6 py-1 rounded-full text-center  px-2'>
      <h1
        style={{
        ...
        className='dark:text-gray-200 text-gray-600  font-bold'>
        جاري التحميل
      </h1>
      <svg
